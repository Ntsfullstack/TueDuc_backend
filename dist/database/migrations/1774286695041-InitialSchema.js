...
exports.InitialSchema1774286695041 = void 0;
class InitialSchema1774286695041 {
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "courses" ADD CONSTRAINT "FK_024283fb9758a30d83079b68d57" FOREIGN KEY ("class_id") REFERENCES "classes"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "assessments" ADD CONSTRAINT "FK_66b3358e73f780151e0a28c196f" FOREIGN KEY ("teacher_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
    async down(queryRunner) {
        await queryRunner.query(`ALTER TABLE "assessments" DROP CONSTRAINT "FK_66b3358e73f780151e0a28c196f"`);
        ...
        await queryRunner.query(`ALTER TABLE "courses" DROP CONSTRAINT "FK_024283fb9758a30d83079b68d57"`);
...
exports.InitialSchema1774286695041 = InitialSchema1774286695041;
//# sourceMappingURL=1774286695041-InitialSchema.js.map